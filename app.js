...
/**
 * @todo Implementar os exercicíos finals propostos, antes do projeto final.
 */
...
}else{console.log('Até mais, você é menor de idade.');}
...
if (numero == 0) {
    ...
    }else{console.log('Valor positivo inserido');}
}
